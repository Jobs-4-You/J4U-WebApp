  ...
  return (
    <Container>
      ...
      <Typography paragraph={true}>
        ...
        complétées par des données administratives déjà disponibles (par ex.
      ...
      <Typography paragraph={true}>
        <strong>Déroulement pour les participants</strong>
        <br />
      ...
      <Typography paragraph={true}>
        ...
        Nous n’avons pas d’information sur votre état de santé. Vous participez
        à cette étude en toute connaissance de cause de votre état de santé.
      </Typography>
      <Typography paragraph={true}>
        <strong>Bénéfices pour les participants</strong>
        <br />
      ...
      <Typography paragraph={true}>
        <strong>Droits des participants</strong>
        <br />
      ...
      <Typography paragraph={true}>
        <strong>Financement de l'étude</strong>
        <br />
        Ce projet est financé par les Fonds National Suisse de la recherche
        Scientifique.
      </Typography>
      <Typography paragraph={true}>
        <strong>Lien avec fiche de recherche d’emploi de l’ORP</strong>
        <br />
